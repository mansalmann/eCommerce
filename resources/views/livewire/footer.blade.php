    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="col-span-full lg:col-span-1">
                <a class="flex-none text-xl font-semibold text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="#" aria-label="Brand">OnlineClothing</a>
            </div>
            <!-- End Col -->
            ...
            <div class="col-span-1">
                <h4 class="font-semibold text-gray-100">Profile</h4>

                <div class="mt-3 grid space-y-3">
                    <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="https://github.com/mansalmann">About me</a></p>
                </div>
            </div>
            <!-- End Col -->
            <!-- End Grid -->
        ...
        <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-center sm:items-center">
            <div class="flex justify-center items-center">
                <p class="text-sm text-gray-400">© 2025 Salman. All rights reserved.</p>
            </div>
            <!-- Social Brands -->
            <div>
