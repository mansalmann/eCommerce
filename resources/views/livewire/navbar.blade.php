        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="{{ route('home') }}" aria-label="Home">OnlineClothing</a>
                <div class="md:hidden">
                    <button type="button"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->routeIs('home') ? 'text-blue-600' : '' }} py-3 md:py-6 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="{{ route('home') }}" aria-current="page">Home</a>

                        <a wire:navigate
                            class="font-medium {{ request()->routeIs('products') ? 'text-blue-600' : '' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="{{ route('products') }}">
                            Products
                        </a>

                        <a wire:navigate
                            class="font-medium flex items-center {{ request()->routeIs('cart') ? 'text-blue-600' : '' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="{{ route('cart') }}">
                        ...
                        <button wire:navigate type="button"
                            class="hs-dark-mode hs-dark-mode-active:hidden inline-flex items-center gap-x-2 py-2 rounded-full text-sm text-dark focus:outline-none"
                        ...
                        <button wire:navigate type="button"
                            class="hs-dark-mode hs-dark-mode-active:inline-flex hidden items-center gap-x-2 py-2 rounded-full text-sm text-white focus:outline-none"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        wire:navigate href="{{ route('user-orders') }}">
                                        My Orders
                                    </a>
